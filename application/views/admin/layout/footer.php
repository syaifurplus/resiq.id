...
<!-- Bootstrap Core Js -->
<script src="<?= base_url(); ?>/assets/admin/plugins/plugins/bootstrap/js/bootstrap.js"></script>

<!-- Select Plugin Js -->
<script src="<?= base_url(); ?>/assets/admin/plugins/bootstrap-select/js/bootstrap-select.js"></script>

<!-- Slimscroll Plugin Js -->
<script src="<?= base_url(); ?>/assets/admin/pluginsplugins/jquery-slimscroll/jquery.slimscroll.js"></script>
